...
function load_css()
{
    ...
    wp_register_style( 'css', get_template_directory_uri().'/css/app.css', array(), false, 'all' );
...
function load_js()
{
    ...
    wp_register_script( 'app', get_template_directory_uri().'/js/app.js', 'jquery', false, true);
